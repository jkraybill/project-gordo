...
1. **Co-foundational bootstrap:** Is MCAP foundational (process), Project Gordo foundational (values), or are they co-foundational? Proto-MCAP concept proposed.
2. **Non-negotiable values:** What are the "very basic non-negotiables" every downstream must inherit?
3. **Lineage model:** How does the Apache-style umbrella work? What's inherited vs locally defined?
4. **Viral propagation:** The "GPL for values" mechanism -- how do values propagate through adoption?
